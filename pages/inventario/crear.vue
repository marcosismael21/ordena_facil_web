    ...
    <v-container>
        ...
        <v-card>
            <v-card-title class="d-flex align-center justify-space-between py-4">
                ...
                <span class="text-h6 ma-0">Crear Producto</span>
                            ...
                            <v-row>
                                <v-col cols="6">
                                    <v-text-field v-model="formData.descripcion" label="Nombre del Producto"
                                        placeholder="Ej. Coca-Cola 500ml" :rules="[rules.required, rules.descripcion]"
                                ...
                                <v-col cols="6">
                                    <v-autocomplete v-model="formData.proveedorId" :items="proveedores"
                                        label="Proveedor" :rules="[rules.estadoRequired]" required item-title="nombre"
                                        variant="outlined" item-value="id">
                                    </v-autocomplete>
                                </v-col>
                                <v-col cols="6">
                                    <v-autocomplete v-model="formData.tipoMedidaId" :items="tiposMedidas"
                                        label="Tipo de Medida" :rules="[rules.estadoRequired]" required
...
const handleCreate = async () => {
    ...
    try {
        ...
        snackbarColor.value = "error"
        snackbarMessage.value = e.message || "Error al crear el producto"
        isSnackbarVisible.value = true
    } finally {
        loading.value = false
    }
